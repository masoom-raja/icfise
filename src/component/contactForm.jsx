        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="Diploma in Industrial Safety & Fire Management">
                Diploma in Industrial Safety & Fire Management
              </option>
              <option value="Diploma in Construction Safety and Health Management">
                Diploma in Construction Safety and Health Management
              </option>
              <option value="Advance Diploma in Industrial Safety">
                Advance Diploma in Industrial Safety
              </option>
              <option value="PG Diploma in Industrial Safety management">
                PG Diploma in Industrial Safety management
              </option>
              <option value="PG Diploma in Fire and Safety management">
              ...
              <option value="OSHA 30 HOURS - General Industry Training">
                OSHA 30 HOURS - General Industry Training
              </option>
              <option value="First Aid & CPR Training">
                First Aid & CPR Training
              </option>
              <option value="Basic Scaffolding Competent Person">
