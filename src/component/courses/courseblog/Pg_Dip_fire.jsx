 ...
 <section className="py-4 bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] col-span-2">
  <div className="container mx-auto px-4 max-w-8xl">
    ...
    <p className="text-gray-700 leading-relaxed mb-2">
      ...
      the PG Diploma in Fire & Safety Management is designed for individuals who aim to develop 
      advanced expertise in fire safety, risk management, and emergency response systems. With 
      increasing safety regulations and industrial expansion, the demand for highly skilled fire 
      and safety professionals is growing rapidly.
    </p>

    <p className="text-gray-700 leading-relaxed mb-4">
      This program equips students with both managerial and technical skills required to handle 
      fire hazards, safety planning, and emergency situations effectively. Students learn to 
      implement fire protection systems, manage risks, and ensure safety compliance across 
      various industries.
    </p>
    ...
    <div className="bg-white p-2 rounded-lg mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li><strong>Course Name:</strong> PG Diploma in Fire & Safety Management</li>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <p className="text-gray-700 leading-relaxed">
        This course focuses on advanced fire safety management, including fire prevention systems, 
        emergency planning, risk assessment, industrial safety standards, and regulatory compliance. 
        It prepares students to manage fire safety operations and lead safety teams in complex environments.
      </p>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Advanced Fire Safety Systems</h3>
          <p className="text-gray-600 text-sm">
            Covers fire detection, suppression systems, emergency planning, and safety compliance.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Practical & Simulation Training</h3>
          <p className="text-gray-600 text-sm">
            Hands-on training with fire drills, safety equipment, and real-life emergency scenarios.
          </p>
        </div>
        ...
        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          ...
          <p className="text-gray-600 text-sm">
            Learn from experienced professionals with expertise in fire safety and industrial risk management.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li>✔ High demand for fire and safety professionals</li>
        <li>✔ Advanced and industry-relevant curriculum</li>
        <li>✔ Opportunities in India and international markets</li>
