...
<section className="py-4 bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] col-span-2">
  <div className="container mx-auto px-4 max-w-8xl">
    ...
    <p className="text-gray-700 leading-relaxed mb-2">
      ...
      the IOSH Managing Safely course is designed for managers, supervisors, and team leaders who 
      are responsible for safety within their organizations. This globally recognized certification 
      helps professionals understand their role in maintaining a safe and healthy workplace.
    </p>

    <p className="text-gray-700 leading-relaxed mb-4">
      The program provides practical knowledge of risk assessment, hazard control, and safety 
      management techniques. It empowers learners to confidently identify workplace risks, reduce 
    ...
    <div className="bg-white p-2 rounded-lg mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li><strong>Course Name:</strong> IOSH Managing Safely</li>
        <li><strong>Duration:</strong> 3–5 Days</li>
        <li><strong>Eligibility:</strong> Open for managers, supervisors, and working professionals</li>
      </ul>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <p className="text-gray-700 leading-relaxed">
        This course focuses on essential safety management principles including hazard identification, 
        risk assessment, incident investigation, and performance measurement. It provides a clear 
        understanding of responsibilities for maintaining safety in the workplace.
      </p>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Globally Recognized Certification</h3>
          <p className="text-gray-600 text-sm">
            IOSH certification is widely accepted across industries worldwide.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Practical Risk Management</h3>
          <p className="text-gray-600 text-sm">
            Learn how to identify, assess, and control risks in real workplace environments.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Easy-to-Understand Modules</h3>
          <p className="text-gray-600 text-sm">
            Simple and practical approach suitable for non-technical professionals.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li>✔ Globally recognized IOSH certification</li>
        <li>✔ Short duration with high career value</li>
        <li>✔ Practical and easy-to-understand training</li>
        <li>✔ Enhances workplace safety and leadership skills</li>
      </ul>
    </div>
