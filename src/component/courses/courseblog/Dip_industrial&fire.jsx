...
import course from "../../../assets/dip_industrial.jpeg"
import Vdo from "../../../assets/vdo.mp4"
import { Swiper, SwiperSlide } from "swiper/react";
import "swiper/css";
import ContactFrom from "../../contactForm";

export default function Dip_industrial() {
  ...
  <section className="py-4 bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] col-span-2">
      <div className="container mx-auto px-4 max-w-8xl">
        ...
        <p className="text-gray-700 leading-relaxed mb-2">
          ...
          the Diploma in Industrial Safety & Fire Management is carefully structured for individuals 
          who want to build a strong career in safety engineering and fire risk management. With 
          industries expanding rapidly, the demand for trained safety professionals continues to grow.
        </p>

        <p className="text-gray-700 leading-relaxed mb-4">
          This program focuses on developing both technical knowledge and practical skills required 
          to handle real-world safety challenges. Students are trained to identify risks, prevent 
          accidents, and respond effectively during fire and industrial emergencies.
        </p>
        ...
        <div className="bg-white p-2 rounded-lg mb-10">
          ...
          <ul className="space-y-2 text-gray-700">
            <li><strong>Course Name:</strong> Diploma in Industrial Safety & Fire Management</li>
        ...
        <div className="mb-10 bg-white p-2">
          ...
          <p className="text-gray-700 leading-relaxed">
            This course focuses on fire prevention techniques, emergency response handling, safety 
            regulations, and industrial hazard control. Students gain both theoretical knowledge and 
            practical understanding of fire safety systems and industrial safety management.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-5 bg-white rounded-lg  hover:border-[#d97706]/50 transition">
              ...
              <p className="text-gray-600 text-sm">
                Covers fire protection systems, industrial safety standards, and risk control methods.
              </p>
            </div>
            ...
            <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
              ...
              <p className="text-gray-600 text-sm">
                Hands-on training through drills, equipment handling, and real-life simulations.
              </p>
            </div>
            ...
            <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
              ...
              <p className="text-gray-600 text-sm">
                Learn from experienced trainers with strong industry expertise.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <ul className="grid sm:grid-cols-2 gap-3 text-gray-700">
            {[
              "Safety Officer",
              "Fireman / Fire Safety Technician",
              "HSE Executive",
              "Safety Supervisor",
        ...
        <div className="mb-10">
          ...
          <ul className="space-y-2 text-gray-700">
            <li>✔ High demand for certified safety professionals</li>
            <li>✔ Practical training aligned with industry needs</li>
