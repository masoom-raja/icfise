...
import course from "../../../asset/first-aid-cpr.jpg"
...
<section className="py-4 bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] col-span-2">
  <div className="container mx-auto px-4 max-w-8xl">
    ...
    <p className="text-gray-700 leading-relaxed mb-2">
      ...
      the First Aid & CPR Training program is designed to equip individuals with life-saving skills 
      required during medical emergencies. This course is essential for anyone who wants to respond 
      quickly and effectively in critical situations.
    </p>

    <p className="text-gray-700 leading-relaxed mb-4">
      The training focuses on immediate care techniques, including CPR, injury management, and 
      emergency response. Participants gain confidence to handle real-life situations and provide 
      first response before professional medical help arrives.
    </p>
    ...
    <div className="bg-white p-2 rounded-lg mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li><strong>Course Name:</strong> First Aid & CPR Training</li>
        <li><strong>Duration:</strong> 1–2 Days</li>
        <li><strong>Eligibility:</strong> Open for all individuals, students, and professionals</li>
      </ul>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <p className="text-gray-700 leading-relaxed">
        This course covers essential first aid techniques including CPR (Cardiopulmonary Resuscitation), 
        wound care, bleeding control, fracture management, and emergency response procedures. It provides 
        both theoretical knowledge and practical training to handle medical emergencies effectively.
      </p>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Life-Saving Techniques</h3>
          <p className="text-gray-600 text-sm">
            Learn CPR, first aid response, and emergency care techniques.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Hands-On Training</h3>
          <p className="text-gray-600 text-sm">
            Practical sessions with real-life scenarios and training equipment.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Emergency Preparedness</h3>
          <p className="text-gray-600 text-sm">
            Gain confidence to act quickly in critical situations.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li>✔ Essential life-saving skill for everyone</li>
        <li>✔ Short duration with practical training</li>
        <li>✔ Useful for workplace and daily life emergencies</li>
        <li>✔ Certification improves employability</li>
      </ul>
    </div>
