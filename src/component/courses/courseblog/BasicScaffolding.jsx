...
import course from "../../../assets/Basic_Scaff.jpeg"
import Vdo from "../../../assets/vdo.mp4"
import { Swiper, SwiperSlide } from "swiper/react";
import "swiper/css";
import ContactFrom from "../../contactForm"

export default function BasicScaffolding() {
...
<section className="py-4 bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] col-span-2">
  <div className="container mx-auto px-4 max-w-8xl">
    ...
    <p className="text-gray-700 leading-relaxed mb-2">
      ...
      the Basic Scaffolding Competent Person course is designed to train individuals in safe 
      scaffolding practices and inspection techniques. This course is essential for those working 
      in construction and industrial environments where scaffolding safety is critical.
    </p>

    <p className="text-gray-700 leading-relaxed mb-4">
      The program focuses on practical knowledge and hands-on skills required to erect, inspect, 
      and maintain scaffolding structures safely. It prepares learners to identify risks and 
      ensure compliance with safety standards on-site.
    </p>
    ...
    <div className="bg-white p-2 rounded-lg mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li><strong>Course Name:</strong> Basic Scaffolding Competent Person</li>
        <li><strong>Duration:</strong> 3–7 Days</li>
        <li><strong>Eligibility:</strong> Open for workers, technicians, and construction professionals</li>
      </ul>
    </div>
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <p className="text-gray-700 leading-relaxed">
        This course covers scaffolding fundamentals including types of scaffolds, erection and 
        dismantling procedures, inspection methods, load handling, and safety regulations. It 
        provides both theoretical understanding and practical training to ensure safe scaffolding 
    ...
    <div className="mb-10 bg-white p-2">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Scaffolding Safety Basics</h3>
          <p className="text-gray-600 text-sm">
            Learn safe erection, dismantling, and usage of scaffolding systems.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Inspection & Risk Control</h3>
          <p className="text-gray-600 text-sm">
            Understand how to inspect scaffolds and identify potential hazards.
          </p>
        </div>

        <div className="p-5 bg-white rounded-lg hover:border-[#d97706]/50 transition">
          <h3 className="font-bold text-[#1e3a5f] mb-2">Hands-On Practical Training</h3>
          <p className="text-gray-600 text-sm">
            Real-world training on scaffolding setup and safety practices.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="mb-10">
      ...
      <ul className="space-y-2 text-gray-700">
        <li>✔ Essential skill for construction and industrial work</li>
        <li>✔ Practical, hands-on training approach</li>
        <li>✔ Improves job safety and site efficiency</li>
        <li>✔ Certification increases job opportunities</li>
      </ul>
    </div>
